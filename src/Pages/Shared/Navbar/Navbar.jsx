...
const Navbar = () => {
	...
	const navOption = (
		<>
			<Link to="/">
				<li className="mr-7 text-lg font-bold hover:text-red-500">Home</li>
			</Link>

			<Link to="/gallery">
				<li className="mr-7 text-lg font-bold hover:text-red-500">
					Gallery
				</li>
			</Link>

			<Link to="/dashboard/myProfile">
				<li className="text-lg font-bold hover:text-red-500">Dashboard</li>
			</Link>
		</>
	);
	return (
		<div>
			<div className="navbar ">
				...
				<div className="navbar-end">
					<IoIosNotifications className="text-4xl mx-4 cursor-pointer"></IoIosNotifications>
